...
1. จงเขียนโปรแกรมสร้าง Array เก็บคะแนนสอบของนักเรียน 5 คน และ:
   ...
   - แสดงจำนวนคนที่ได้คะแนนมากกว่าค่าเฉลี่ย
     ...
     ![Screenshot 2024-12-10 135827](https://github.com/user-attachments/assets/dfb37e13-5aee-4676-8169-5b2deac1f09e)
...
2. สร้างโปรแกรมจัดการรายชื่อสินค้าในร้านค้า โดยมีฟังก์ชัน:
   ...
   - แสดงรายการสินค้าทั้งหมด
     ...
     ![Screenshot 2024-12-10 140500](https://github.com/user-attachments/assets/791d2a9c-5fee-4aab-b9be-65813d11d5d7)
...
1. จงเขียนโปรแกรมจัดการคะแนนสอบ:
   ...
   - แสดงจำนวนนักเรียนที่สอบผ่านแต่ละวิชา (คะแนนผ่าน ≥ 50)
     ...
     ![Screenshot 2024-12-10 141918](https://github.com/user-attachments/assets/5f3a2fbc-d0d5-4d89-9412-5cfe7a6d9715)
...
2. สร้างโปรแกรมจัดการที่นั่งในโรงภาพยนตร์:
   ...
   - แสดงจำนวนที่นั่งว่างทั้งหมด
     ...
     ![image](https://github.com/user-attachments/assets/4fcf1a18-7473-446e-9c0e-388fd187f467)
...
1. จงเขียนโปรแกรมจัดการข้อมูลอุณหภูมิ:
   ...
   - หาวันและเวลาที่อุณหภูมิสูงที่สุดของแต่ละเมือง
     ...
     ![image](https://github.com/user-attachments/assets/a73e0597-66e8-44cf-942d-27b25ce06206)
...
2. เขียนโปรแกรมวิเคราะห์ผลการเรียน:
   ...
   - แสดงจำนวนนักเรียนที่สอบผ่านทุกวิชาในแต่ละห้อง
     ...
     ![image](https://github.com/user-attachments/assets/16061791-9b5a-4e8b-8a63-b1f36c79587d)
